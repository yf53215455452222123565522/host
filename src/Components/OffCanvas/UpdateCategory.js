  ...
  return (
    ...
    >
      <ModalHeader className="border-0 px-4">
        <ModalTitle>
          <h5 className="fw-bold text-black mb-1">modifiez catégorie</h5>
        </ModalTitle>
      </ModalHeader>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label
            ...
            {/* <textarea
              ...
              name="bannerImage"
              placeholder="number"
              value={updatedCategory.bannerImage}
              onChange={handleInputChange}
            /> */}
          ...
          <button href="#" className="btn btn-primary w-100 text-uppercase btn-lg fw-bold col rounded-3" data-bs-dismiss="offcanvas" aria-label="Close" >Modifier</button>
