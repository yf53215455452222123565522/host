...
import { attribuerOrderPreparateur, fetchOrders, payOrder } from '../../Redux/orders';
...
import LivreurHeader from "../../Components/Headers/LivreurHeader";
    ...
    <div className="container">
      ...
      <Table responsive striped bordered hover size="sm">
        ...
        console.log(Order)}}>Détails</Button>
         ...
         {order.state.state==="prête à livré"?<Button className="mx-4 my-1 " onClick={()=>{
          dispatch(payOrder({"order":order.id,"email":email}));
