...
import { fetchPayments, fetchUserPayments } from "../../Redux/payments";
...
export default function UserPayments() {
  ...
  return (
    <>
      ...
      <h3 className="text-center">Aucun paiement effectué par ce client à la base de données pour le moment</h3>
     </div>
}
    </>
  )
